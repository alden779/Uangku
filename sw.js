const CACHE='uangku-shell-v7';const assets=['./','./index.html','./app.js','./app.js?v=20260918-drive4','./finance.js','./exports.js','./backup.js','./cloud-backup.js','./cloud-backup.js?v=20260918-drive3','./backup-feedback.js','./cloud-config.js','./cloud-config.js?v=20260918-drive2','./style.css','./style.css?v=20260918-brand1','./manifest.json','./icon.svg','./icon-180.png','./icon-192.png','./icon-512.png'];
