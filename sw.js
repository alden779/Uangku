const CACHE='uangku-shell-v3';const assets=['./','./index.html','./app.js','./finance.js','./exports.js','./backup.js','./cloud-backup.js','./cloud-config.js','./style.css','./manifest.json','./icon.svg','./icon-180.png','./icon-192.png','./icon-512.png'];
